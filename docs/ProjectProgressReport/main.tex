...
Moving forward, our focus will be on enhancing interpretability, experimenting with calibrated probability outputs, and validating whether transformer-derived embeddings improve performance consistency across minority classes. The feedback confirmed that our implementation direction is sound but encouraged deeper visualization and comparative analysis to strengthen communication of model behaviour.

% \section*{Limitations}

\section*{Team Contributions}

Imran Chowdhury implemented the data cleaning, TF-IDF feature extraction, and Linear SVC training pipeline, producing the final evaluation metrics and confusion matrices. Karim Elbasiouni refined the baseline models, updated visualization outputs, and coordinated feedback with the teaching assistant. Rami Abu Sultan compiled the progress report, integrated code results, and finalized the submission in \LaTeX{}.
